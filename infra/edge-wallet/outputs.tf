...
output "common_tags" {
  description = "Common tags applied to wallet edge resources."
  value       = local.common_tags
}

output "service_name" {
  description = "Logical backend service name for wallet traffic."
  value       = "wallet-backend"
}

output "load_balancer_hostname" {
  description = "Shared internal ALB hostname used by wallet edge routing."
  value       = data.terraform_remote_state.platform.outputs.shared_alb_dns_name
}

output "target_group_arn" {
  description = "ALB target group ARN for wallet backend."
...
output "api_gateway_id" {
  description = "HTTP API Gateway ID for wallet."
  value       = module.edge.api_gateway_id
}

output "api_gateway_endpoint" {
  description = "HTTP API Gateway endpoint for wallet."
  value       = module.edge.api_gateway_endpoint
}

output "docs_url" {
  description = "Swagger UI URL for wallet."
  value       = module.edge.docs_url
}

output "custom_domain_name" {
  description = "Custom domain name for wallet, when enabled."
  value       = module.edge.custom_domain_name
}

output "custom_domain_docs_url" {
  description = "Swagger UI URL on the wallet custom domain, when enabled."
  value       = module.edge.custom_domain_docs_url
}

output "api_route" {
  description = "API Gateway route path for wallet."
